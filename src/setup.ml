...
(* OASIS_START *)
(* DO NOT EDIT (digest: 57e0b2e9a2d125601ec2fd33c363c50d) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("make", ["tests"]))];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "apigen.ml"});
               Test
                 ({
                     cs_name = "regressions";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\167\245\201I\152\007l\168\026(W\152\133\131\020L";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
