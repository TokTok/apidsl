 ...
 *
 */
void toxav_callback_audio_bit_rate_status(ToxAV *av, toxav_audio_bit_rate_status_cb *callback, void *user_data);
 ...
 *
 */
void toxav_callback_video_bit_rate_status(ToxAV *av, toxav_video_bit_rate_status_cb *callback, void *user_data);
 ...
 * 
 */
bool toxav_video_bit_rate_set(ToxAV *av, uint32_t friend_number, uint32_t audio_bit_rate, bool force, TOXAV_ERR_SET_BIT_RATE *error);
 ...
 */
typedef void toxav_video_receive_frame_cb(ToxAV *av, uint32_t friend_number, uint16_t width, uint16_t height, const uint8_t *y, const uint8_t *u, const uint8_t *v, const uint8_t *a, int32_t ystride, int32_t ustride, int32_t vstride, int32_t astride, void *user_data);
